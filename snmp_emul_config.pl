...
function check_enable()
{
  ...
  <div class="container">
     <section id="upload">
       <div class="container">
         <form action="/select" method="POST" name="able">
           <div class="span12">		
             <div class="span_frame5 pagination-centered">
               <div>
                 Available
               </div>
               <select multiple name="sel_available" id="sel_available" size=10 style="width:300px;" onchange="check_enable();">
<%== $list_available %>
               </select> 
             </div>			
             <div class="span1 pagination-centered">
               ...
               <button type="button" class="btn-medium" name="bt_able" id="bt_able" onclick="this.form.submit();">
                 &lt;&gt;
               </button>
               <div>
                 &nbsp;
             ...
             <div class="span_frame5 pagination-centered">
               ...
               <select multiple name="sel_enable" id="sel_enable" size=10 style="width:300px;" onchange="check_available();">
<%== $list_enable %>
               </select> 
             </div>
           </form>
